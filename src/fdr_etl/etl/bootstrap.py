...
def compute_weighted_bootstrap(df, group_col, n_iterations=1000, nb_years=1.0, batch_size=1000):
    """
    ...
    for group in groups:
        ...
        while iterations_faites < n_iterations:
            ...
            indices = np.random.choice(n_rows, size=(current_batch, n_rows), replace=True)
