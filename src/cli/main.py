...
def main():
    ...
    validate_parser = subparsers.add_parser("validate", help="Valider un fichier en local")
    validate_parser.add_argument("filepath", type=str, help="Chemin du fichier à valider")
